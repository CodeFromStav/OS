...
void runTimer( int milliSeconds )   //this is just a spinner, runs time
   {
...
double accessTimer( int controlCode, char *timeStr ) //parameters are input, type double is output. Pass in a string capable of holding what you want to get back. 
   {
